...
class Say::RJBannerTest < Minitest::Spec
  describe "Say::RJBanner" do
    describe "#initialize" do
      context "GIVEN no args" do
        subject { Say::RJBanner }
    ...
    describe "#call" do
      context "GIVEN the default interpolation template" do
        ...
        context "GIVEN a columns arg" do
          subject { Say::RJBanner.new(columns: 20) }
        ...
        context "GIVEN columns arg < the given String" do
          subject { Say::RJBanner.new(columns: 0) }
    ...
    describe "Say::RJBanner::InterpolationTemplateFiller" do
      describe "#initialize" do
        subject { Say::RJBanner::InterpolationTemplateFiller }
      ...
      describe "#call" do
        context "GIVEN a fill pattern" do
          subject {
            Say::RJBanner::InterpolationTemplateFiller.new(
              banner: Say::RJBanner.new("-{}-", columns: 20),
    ...
    describe "Say::RJBanner::InterpolationTemplateBuilder" do
      describe "::TYPES" do
        subject { Say::RJBanner::InterpolationTemplateBuilder }

        let(:types) { Say::RJBanner::InterpolationTemplateBuilder::TYPES }
